      ...
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
        ...
        >
          ...
          <motion.div variants={revealSoft}>
            <div
              className="mb-8 inline-flex items-center gap-2.5 rounded-full border border-border px-3.5 py-1.5 backdrop-blur-sm"
          ...
          {/* Divider accent */}
          <motion.div variants={revealSoft} className="mt-10 flex items-center gap-3" />
        </motion.div>
      </div>
    </section>
  )
