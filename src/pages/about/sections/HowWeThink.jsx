...
// ─── Card reveal ──────────────────────────────────────────────────────────────
const CardMotion = ({ children, delay = 0, isInView, reducedMotion, className = '' }) => (
  <motion.div
    className={className}
        ...
        <div className="overflow-hidden rounded-2xl border border-border">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4">
            ...
            <CardMotion
              delay={0.05}
              {...mp}
              className="col-span-2 lg:col-span-2 lg:row-span-2 relative overflow-hidden flex flex-col justify-between bg-primary p-8 sm:p-10"
              style={{ minHeight: 340 }}
            >
              {/* border using style since color-mix() can't be a Tailwind class */}
              <div style={{ position: 'absolute', inset: 0, borderRight: '1px solid color-mix(in oklch, var(--primary-foreground) 12%, transparent)', borderBottom: '1px solid color-mix(in oklch, var(--primary-foreground) 12%, transparent)', pointerEvents: 'none' }} />
              ...
              <div className="relative z-10">
                ...
                <h3
                  className="mt-4 font-heading font-extrabold leading-tight tracking-[-0.03em] text-primary-foreground"
            ...
            <CardMotion
              delay={0.12}
              {...mp}
              className="col-span-2 lg:col-span-1 lg:row-span-2 relative overflow-hidden flex flex-col justify-between bg-surface p-6 sm:p-8"
              style={{
            ...
            <CardMotion
              delay={0.18}
              {...mp}
              className="col-span-2 lg:col-span-1 lg:row-span-2 relative overflow-hidden flex flex-col justify-between bg-card p-6 sm:p-8"
              style={{
                borderBottom: '1px solid var(--border)',
                borderTop: '1px solid var(--border)',
              }}
          ...
          <CardMotion
            delay={0.22}
            {...mp}
            className="relative overflow-hidden flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 bg-surface p-8 sm:p-10"
            style={{
              borderTop: '1px solid var(--border)',
              borderBottom: '1px solid var(--border)',
            }}
