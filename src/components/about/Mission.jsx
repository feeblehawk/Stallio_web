...
// ─── Globe dots — scattered across the sphere surface ────────────────────────
// Each point: [cx, cy] in a 200×200 viewBox.
// The globe is drawn as a circle at (100,100) r=88.
// Points are placed to suggest global commerce hubs — not geographically precise,
// but visually convincing as a world distribution. Density varies by region.
const GLOBE_DOTS = [
  // North America
  { x: 32,  y: 72,  major: false },
  { x: 44,  y: 65,  major: true  }, // ~New York
  { x: 28,  y: 88,  major: false },
  { x: 48,  y: 95,  major: true  }, // ~Chicago / mid-US
  ...
  { x: 104, y: 55,  major: true  }, // ~London/Paris
  ...
  { x: 138, y: 90,  major: true  }, // ~South Asia / Stallio region
  { x: 144, y: 100, major: true  },
  { x: 136, y: 108, major: false },
  // East Asia / SE Asia
  { x: 158, y: 72,  major: false },
  { x: 166, y: 80,  major: true  }, // ~East Asia
...
// Rendered as SVG ellipses clipped inside the globe circle to simulate a sphere.
        ...
        >
          ...
          <div>
            ...
            <motion.blockquote
              variants={reveal}
              {...motionProps}
              className="max-w-2xl border-l-[3px] pl-8 sm:pl-12"
            ...
            <motion.p
              variants={revealSoft}
              {...motionProps}
              className="mt-10 max-w-xl text-sm leading-7 sm:text-base"
          ...
          >
            ...
            <div className="relative flex items-center justify-center px-6 py-8">
              ...
              >
                ...
                {/* Lat/lng grid — clipped inside globe */}
                ...
                {/* Commerce dots — stagger in on scroll */}
            ...
            >
              {[
                ...
                >
                  <span
                    className="font-heading font-extrabold tracking-[-0.03em] leading-none"
