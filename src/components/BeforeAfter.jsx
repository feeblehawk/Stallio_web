...
const beforePoints = [
  'Orders scattered across chats and voice notes',
  'Customers ask the same questions again and again',
  'No single place to browse products or check prices',
]

const afterPoints = [
  'One polished storefront people can browse on mobile',
  'Clear product pages and checkout flow in one link',
  'Less back-and-forth, more confidence and conversions',
]
      ...
      <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 id="before-after-heading" className="mt-4 font-heading font-extrabold tracking-[-0.045em]" style={{ fontSize: 'clamp(2.2rem, 5vw, 4rem)', lineHeight: 1.02, color: 'var(--foreground)' }}>
            From scattered chats<br className="hidden sm:block" /> to one clear storefront.
          </h2>
